...
Stream queues support advanced message filtering capabilities, allowing consumers to receive only messages that match specific criteria. This is useful for efficiently consuming subsets of messages from a single queue.
