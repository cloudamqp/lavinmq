...
SHA256SUM := $(shell command -v sha256sum > /dev/null 2>&1 && echo "sha256sum -c -" || echo "shasum -a 256 -c -")
.DELETE_ON_ERROR:
...
static/js/lib/chart.js: | static/js/lib
	...
	echo "038d0a4f9c61f0b35ff70f883e7591403a349542625a4caaf48caa141adedfd5  $@" | $(SHA256SUM)

static/js/lib/chunks/helpers.segment.js: | static/js/lib/chunks
	curl --fail --retry 5 -sL https://github.com/chartjs/Chart.js/releases/download/v4.0.1/chart.js-4.0.1.tgz | \
	tar -zxOf- package/dist/chunks/helpers.segment.js > $@
	echo "b4746b748fe583a18ef921e341b8b65166c2ebd0b737fde6527b254baaeb1aa1  $@" | $(SHA256SUM)

static/js/lib/luxon.js: | static/js/lib
	curl --fail --retry 5 -sLo $@ https://moment.github.io/luxon/es6/luxon.mjs
	echo "b495ad5cabea3439d04387e6622f2c3fa81d319424d9d76d9e7f874ac5a0807a  $@" | $(SHA256SUM)
...
static/js/lib/chartjs-adapter-luxon.esm.js: | static/js/lib
	...
	echo "17d7b6567d656a004f86b6b5cbdbe64cb308e9a2ebfa7675caa79ba0bc72ef91  $@" | $(SHA256SUM)
...
static/js/lib/elements-8.2.0.js: | static/js/lib
	...
	echo "598862da6d551769ebad9d61d4e3037535de573a13d3e0bd1ded4c5fc65c5885  $@" | $(SHA256SUM)
...
static/js/lib/elements-8.2.0.css: | static/js/lib
	...
	echo "119784e23ffc39b6fa3fdb3df93f391f8250e8af141b78dfc3b6bed86079f93b  $@" | $(SHA256SUM)
