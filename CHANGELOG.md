...
- OpenAPI spec: correct shovels/connections paths, document operator-policies, stream queue, and `PUT /channels` endpoints, fix `truncate` field type [#2004](https://github.com/cloudamqp/lavinmq/pull/2004)
