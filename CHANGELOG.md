...
- Standard Webhooks signatures on HTTP shovel deliveries via the `dest-signature-secret` shovel parameter [#1423](https://github.com/cloudamqp/lavinmq/pull/1423)
