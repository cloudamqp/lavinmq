...
module SparkplugSpecs
  # Mirror the production flow: parse the topic, then validate the parts.
  # Returns nil for non-Sparkplug topics (e.g. certificate subscriptions).
  def self.validate(topic : String) : LavinMQ::MQTT::Sparkplug::MessageType?
    parts = LavinMQ::MQTT::Sparkplug::Validator.parse_topic(topic)
    return nil unless parts
    LavinMQ::MQTT::Sparkplug::Validator.validate_topic(parts)
  end
