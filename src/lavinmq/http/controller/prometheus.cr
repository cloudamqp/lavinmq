    ...
    class PrometheusController < Controller
      ...
      private def global_metrics(writer)
        writer.write({name:  "global_messages_delivered_total",
                      value: @amqp_server.vhosts.sum { |_, v| v.message_details[:message_stats][:deliver] } + @amqp_server.deleted_vhost_messages_delivered_total,
                      type:  "counter",
                      help:  ""})
        writer.write({name:  "global_messages_redelivered_total",
                      value: @amqp_server.vhosts.sum { |_, v| v.message_details[:message_stats][:redeliver] } + @amqp_server.deleted_vhost_messages_redelivered_total,
                      type:  "counter",
                      help:  "Total number of messages redelivered to consumers"})
        writer.write({name:  "global_messages_acknowledged_total",
                      value: @amqp_server.vhosts.sum { |_, v| v.message_details[:message_stats][:ack] } + @amqp_server.deleted_vhost_messages_acknowledged_total,
                      type:  "counter",
                      help:  "Total number of messages acknowledged by consumers"})
        writer.write({name:  "global_messages_confirmed_total",
                      value: @amqp_server.vhosts.sum { |_, v| v.message_details[:message_stats][:confirm] } + @amqp_server.deleted_vhost_messages_confirmed_total,
                      type:  "counter",
