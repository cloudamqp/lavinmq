...
module LavinMQ
  module AMQP
    class Consumer < LavinMQ::Client::Channel::Consumer
      ...
      getter? no_ack : Bool
      getter channel : LavinMQ::Client::Channel
      getter queue : Queue
      getter prefetch_count : UInt16 = 0u16
      getter unacked : UInt32 = 0_u32
      ...
      getter has_capacity : ::Channel(Bool) = ::Channel(Bool).new
      ...
      def details_tuple : ConsumerDetails
