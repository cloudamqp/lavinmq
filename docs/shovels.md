...
- `400`, `411`, `413`, `414`, `415`, `422` and `431` describe the message (its body size, content type, `uri_path` or headers), so they reject it without requeue and the source queue's dead-letter exchange handles it.
